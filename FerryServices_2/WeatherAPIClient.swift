...
class WeatherAPIClient {
    ...
    // MARK: - methods
    func fetchWeatherForStopPoint(stopPoint: StopPoint, completion: (weather: LocationWeather?, error: NSError?) -> ()) {
        let requestURL = "data/2.5/weather?lat=\(stopPoint.latitude)&lon=\(stopPoint.longitude)&APPID=\(APIKeys.OpenWeatherMapAPIKey)"
